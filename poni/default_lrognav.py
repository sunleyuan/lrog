...
_C.MODEL.room_activation = "tanh"  # options: sigmoid, relu, none
...
_C.OPTIM.batch_size = 6
_C.OPTIM.num_workers = 1
...
_C.LOGGING.eval_interval = 1000 #1000
_C.LOGGING.ckpt_interval = 1000 #1000
