...
class UNetDecoder_room(nn.Module):
    def __init__(
        self,
        n_classes,
        nsf=16,
...
def get_semantic_encoder_decoder(cfg):
    ...
    encoder, object_decoder, area_decoder, room_decoder = None, None, None, None
    ...
    room_decoder = UNetDecoder_room(
            model_cfg.num_categories,
            model_cfg.nsf,
            bilinear=model_cfg.unet_bilinear_interp,
        )
    return encoder, object_decoder, area_decoder, room_decoder
